...
config.register_player(name="p0", algorithm=FastPlayer())
...
for i in range(num_games):
    ...
    print(game_result['players'][0]['stack'], 'others', [summ_old[z]/(i+1) for z in range(num_players)], "games with 0 stack:", games_with_0)
